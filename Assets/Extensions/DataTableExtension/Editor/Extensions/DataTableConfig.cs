...
namespace DE.Editor
{
    ...
    public static class DataTableConfig
    {
        ...
        /// 数据表C#实体类生成文件夹路径
        /// </summary>
        public const string CSharpCodePath = "Assets/Scripts/Test/DataTableExtension/DataTable";

        /// <summary>
        /// 数据表C#实体类模板存放路径
        /// </summary>
        public const string CSharpCodeTemplateFileName = "Assets/Scripts/Extensions/DataTableExtension/Editor/Resource/DataTableCodeTemplate.txt";

        /// <summary>
        /// 数据表扩展类文件夹路径
        /// </summary>
        public static readonly string ExtensionDirectoryPath = "Assets/Scripts/Test/DataTableExtension/Extensions";
