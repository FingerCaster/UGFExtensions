...
namespace Sudoku
{
    public static class SoundExtension
    {
        ...
        public static int? PlaySound(this SoundComponent soundComponent, int soundId, EntityLogic bindingEntityLogic = null, object userData = null)
        {
            ...
            return soundComponent.PlaySound(AssetUtility.GetSoundAsset(drSound.AssetName), "Sound", Constant.AssetPriority.SoundAsset, playSoundParams, bindingEntityLogic != null ? bindingEntityLogic.Entity : null, userData);
        }
